...
export const OpenCanvasGraphAnnotation = Annotation.Root({
  ...
  /**
   * Whether or not to use GPT Researcher for deep research context.
   */
  gptResearcherEnabled: Annotation<boolean | undefined>,
  /**
   * The research report generated by GPT Researcher.
   * Populated after the gptResearcher subgraph runs.
   */
  researchReport: Annotation<string | undefined>,
});
